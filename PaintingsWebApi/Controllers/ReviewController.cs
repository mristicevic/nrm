...
namespace PaintingsWebApi.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        [HttpGet("painting/{paintingId}")]
        [Authorize]
        [ProducesResponseType(200, Type = typeof(ReviewDto))]
        [ProducesResponseType(400)]
        public IActionResult GetReviewsForAPainting(int paintingId)
        {
            var reviews = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviewsOfAPainting(paintingId));
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery] int paintingId, [FromBody] ReviewDto reviewCreate)
        {
            ...
            reviewMap.Painting = _paintingRepository.GetPainting(paintingId);
