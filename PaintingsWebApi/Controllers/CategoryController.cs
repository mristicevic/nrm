...
namespace PaintingsWebApi.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [HttpGet("painting/{categoryId}")]
        [Authorize]
        [ProducesResponseType(200, Type = typeof(IEnumerable<Painting>))]
        [ProducesResponseType(400)]
        public IActionResult GetPaByCategoryId(int categoryId)
        {
            var pokemons = _mapper.Map<List<PaintingDto>>(
                _categoryRepository.GetPaintingByCategory(categoryId));
